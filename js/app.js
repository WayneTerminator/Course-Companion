const courses = {
  ...
  margate: {
    ...
    holes: [
      { hole: 1, distance: 305, par: 4, stroke: 3, note: "Demanding opener. Place the drive and avoid OB/penalty trouble left. Do not fly the green.", mapImage: "assets/gowrie-hole-guide-10-v1.png" },
      { hole: 2, distance: 120, par: 3, stroke: 7, note: "Par 3 with danger around the green. OB left, water right, bunkers around a two-tier green.", mapImage: "assets/gowrie-hole-guide-11-v1.png" },
      { hole: 3, distance: 330, par: 4, stroke: 5, note: "Longer slight dogleg right. Avoid right fairway bunkers and the penalty area left.", mapImage: "assets/gowrie-hole-guide-12-v1.png" },
      { hole: 4, distance: 126, par: 3, stroke: 13, note: "Short hole over water from elevation. Wind can make this play much longer.", mapImage: "assets/gowrie-hole-guide-13-v1.png" },
      { hole: 5, distance: 385, par: 5, stroke: 15, note: "Gradual uphill par 5. Avoid OB right and trees left; manage the second shot carefully.", mapImage: "assets/gowrie-hole-guide-14-v1.png" },
      { hole: 6, distance: 315, par: 4, stroke: 1, note: "Stroke 1 par 4. Favour the right side as the fairway slopes right-to-left.", mapImage: "assets/gowrie-hole-guide-15-v1.png" },
      { hole: 7, distance: 276, par: 4, stroke: 17, note: "Short dogleg left. Watch the fairway bunkers; a bump-and-run approach can work.", mapImage: "assets/gowrie-hole-guide-16-v1.png" },
      { hole: 8, distance: 149, par: 3, stroke: 11, note: "If missing the green, left is safer. Right brings trees and bunker trouble.", mapImage: "assets/gowrie-hole-guide-17-v1.png" },
      { hole: 9, distance: 386, par: 5, stroke: 9, note: "Drive is key. Water left, later OB left, and a fairway bunker right on the second.", mapImage: "assets/gowrie-hole-guide-18-v1.png" },
...
,
  gowrie: {
    ...
    facts: [
      ...
      { label: "Guides", value: "1–18" }
    ],
    notes: [
      "All 18 Gowrie Farm holes are loaded for scoring.",
      "All 18 holes include course-guide images from the supplied PDF.",
      "Holes 10–18 now also include guide images from the supplied PDF.",
